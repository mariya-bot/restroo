        ...
        <>
            <div data-aos ="fade"  className="bg-white shadow-md">
                <div className="container flex justify-between py-4 sm:py-3">
                    ...
                    <div className="font-bold text-3xl  first-letter:">Logo</div>
               ...
               {/* -------------------------simple dropdown link------------------------- */}
                            ...
                            <li className=" hidden md:block cursor-pointer group ">
                                <a
                                    href="/#"
                                    className="inline-block hover:text-primaryDark text-xl font-semibold"
                                >
                                ...
                                <div className="absolute z-[9999] hidden group-hover:block w-[200px] bg-white text-black shadow-md p-2">
                                    <ul>
                                        {DropdownLinks.map(({ id, name, link }) => (
                                                <li key={id}>
                                                    <a 
                                                    href={link} className=" text-xl inline-block w-full rounded-md p-2 hover:bg-primaryDark/20" 
                                                    >
                                                        {name}
                                                    </a>
                                                </li>
