        ...
        <>
            <div className='py-14 md:py-28 bg-gray-50'>
                <div className='container'>
                    <h1 data-aos="fade-up"
                    // data-aos-delay="300"
                    className='pb-16 tracking-wider texr-2xl font-semibold text-dark text-center'>
                        Why Choose Us</h1>
 ...
 {/* ----------------------card section---------------------------- */}
      ...
      {/* --------------------1st card------------------------------------                       */}
                            ...
                            <div className='text-center flex justify-center items-center flex-col gap-2 px-2'>
                                ...
                                <p className='text-5xl rotate-90 text-primaryDark text-center translate-x-5 '>....</p>
                                <FaBus className='text-5xl text-primaryDark' />
                            </div>
